...
class ProfileUpdateForm(forms.ModelForm):
    cnp = forms.CharField(label='CNP', widget=forms.TextInput(attrs={'placeholder': 'Update your CNP...'}))
    ...
    county = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Update your Country code...'}))
    postal_code = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Update your postal code...'}))
